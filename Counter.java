...
{ 
    ...
    { 
        ...
        if(MyWorld.puntosesq.getValue() >= 150 || MyWorld.puntosjugador1.getValue() <= -100){
            Greenfoot.setWorld(new Ganador2());
            
        }
        if(MyWorld.puntosjugador1.getValue() >= 150 || MyWorld.puntosesq.getValue() <= -100){
            Greenfoot.setWorld(new Ganador1());
